...
public class RestBannerController {
	...
	@PostMapping(value = "/admin/banner/create", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<Banner> bannerCreate(@RequestBody Banner banner){
		return ResponseEntity.ok().body(bannerService.createBanner(banner));
	}
	
	@GetMapping(value = "/admin/banner/delete", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> deleteBannerById(@RequestParam("id_banner") Long bannerId) {
